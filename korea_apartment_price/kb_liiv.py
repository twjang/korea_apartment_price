...
class KBLiivCrawler:
    ...
    def list_city(self, city: KBCity):
    ...
    def list_gu(self, city: KBCity, gu_name: str):
    ...
    def partial_orderbook(self, apt_id: int, apt_name:str, order_by: str='date', aggregate: bool=True, items_per_page:int=10, page_idx=1):
    ...
    def orderbook(self, apt_id: int, apt_name:str, order_by: str='date', aggregate: bool=True, items_per_page:int=10, page_idx=1):
      cnt, _ = self.partial_orderbook(apt_id, apt_name, order_by, aggregate, 10, 1)
      cnt, res = self.partial_orderbook(apt_id, apt_name, order_by, aggregate, cnt, 1)
      return res
